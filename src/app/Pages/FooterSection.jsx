...
const LINKS = [
    ...
    },
    {
        title: "Recurso",
        items: [
            { name: "Syl Talento1", href: "https://www.facebook.com/SYLTalento1", target: "_blank" },
            { name: "Syl Talento mexicali", href: "https://www.facebook.com/profile.php?id=100063574134270&mibextid=ZbWKwL", target: "_blank" },
            { name: "Whatsapp", href: "https://api.whatsapp.com/send?phone=5216642145977&text=Hola%20Syltalento", target: "_blank" },
            { name: "Tijuana", href: "https://www.google.com/maps/place/SYL+TALENTO/@32.5265676,-117.0379149,19z/data=!3m1!4b1!4m6!3m5!1s0x80d9496b1dc83891:0x624ffaf809fcd4a1!8m2!3d32.5265665!4d-117.0366985!16s%2Fg%2F11s3xwnk7q?entry=ttu", target: "_blank" },
            { name: "Mexicali", href: "https://www.google.com/maps/place/SYL+TALENTO+MEXICALI/@32.6081827,-115.3850134,17z/data=!3m1!4b1!4m6!3m5!1s0x80d77786cb034bc9:0xd47058a0e5a7d5a4!8m2!3d32.6081782!4d-115.3824331!16s%2Fg%2F11t_q_47jg?entry=ttu", target: "_blank" },
        ],
    },
];
        ...
        <footer className="relative w-full mt-8 border-t border-black">
            <div className="w-full px-8 mx-auto mt-8 max-w-7xl">
                    ...
                    <div className="grid justify-between grid-cols-3 gap-4">
                        {LINKS.map(({ title, items }) => (
                            <ul key={title}>
                                ...
                                {items.map(({ name, href, target, modalContent }) => (
                                    <li key={name}>
                                        <Typography
                                            as="a"
                                            onClick={() => openModal(modalContent, name)}
                                            href={href}
                                            target={target}
                                            color="gray"
                ...
                <div className="flex flex-col items-center justify-center w-full py-4 mt-12 border-t border-black md:flex-row md:justify-between">
                    ...
                    >
                        Todos los derechos reservados SYL Talento 2023 &copy; , syltalento.com es desarollado por <a className="text-red-500 hover:text-red-700" href="https://www.e-commetrics.com/">e-commetrics.com</a>
                    </Typography>
                </div>
            </div>
