  ...
  return (
    <footer className="w-full mt-8 bg-white border-t border-black">
      <div className="max-w-screen-xl px-4 mx-auto mt-8 md:px-8">
        ...
        {/* Derechos de autor */}
        <div className="flex flex-col items-center justify-center  w-full py-4 mt-8 border-t border-black md:flex-row md:justify-center">
          <p className="mb-4 font-normal text-blue-gray-900 md:mb-0">
