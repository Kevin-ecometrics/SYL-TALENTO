...
function HeroSection() {
  ...
  return (
    <div
      id="inicio"
      className="flex flex-col items-center justify-center max-w-6xl min-h-screen py-2 mx-auto bg-white"
    >
      <main className="flex flex-col items-center w-full px-4 mt-20 space-y-8 text-center bg-white sm:mt-20">
        ...
        <div className="flex flex-col items-center justify-between w-full space-y-4 sm:flex-row sm:space-y-0">
          <motion.h2
            ...
            animate="visible"
          >
            Nos dedicamos a brindar soluciones de reclutamiento y selección de
            personal, así como suministros de materiales y contaduría en Baja
            California y en toda la República Mexicana.
            <br />
            Somos una empresa 100% comprometida con la innovación, la integridad
            y la calidad.
          </motion.h2>
          <motion.div
            ...
            animate="visible"
          >
            <video className="w-auto h-[300px]" src="/syl_logo.mp4" autoPlay loop muted />{" "}
          </motion.div>
        </div>
      </main>
    </div>
